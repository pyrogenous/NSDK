...
public final class NiteaScreens {
    private static final ResourceLocation ICON = ResourceLocation.fromNamespaceAndPath("nitea", "dynamic/icon");
    ...
    public static void initialized(Screen screen, List<? extends GuiEventListener> widgets, Consumer<AbstractWidget> add) {
        ...
        Button button = new IconButton(pressed -> Minecraft.getInstance().setScreen(new NiteaConsentScreen(screen, false)));
