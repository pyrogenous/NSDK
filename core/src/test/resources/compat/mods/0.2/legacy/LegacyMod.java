...
/**
 * A mod written and compiled against Nitea 0.2, calling every public method it had, the way its docs said to.
 * The compatibility tests compile it against compat/nitea-core-0.2.x.jar and run it on the current Nitea.
